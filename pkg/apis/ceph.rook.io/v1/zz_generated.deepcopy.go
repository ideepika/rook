...
func (in *ObjectStoreUserSpec) DeepCopyInto(out *ObjectStoreUserSpec) {
	*out = *in
	...
	if in.Placement != nil {
		in, out := &in.Placement, &out.Placement
		*out = new(ObjectUserPlacementSpec)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObjectUserPlacementSpec) DeepCopyInto(out *ObjectUserPlacementSpec) {
	*out = *in
	if in.StorageClassTags != nil {
		in, out := &in.StorageClassTags, &out.StorageClassTags
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectUserPlacementSpec.
func (in *ObjectUserPlacementSpec) DeepCopy() *ObjectUserPlacementSpec {
	if in == nil {
		return nil
	}
	out := new(ObjectUserPlacementSpec)
